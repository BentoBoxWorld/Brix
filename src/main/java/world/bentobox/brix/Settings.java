 ...
 * @author Tastybento
 */
@StoreAt(filename="config.yml", path="addons/Brix") // Explicitly call out what name this should have.
@ConfigComment("Brix Configuration [version]")
public class Settings implements WorldSettings {
    ...
    @ConfigEntry(path = "brix.command.island")
    private String playerCommandAliases = "brix br";

    @ConfigComment("The admin command.")
    @ConfigComment("To define alias, just separate commands with white space.")
    @ConfigEntry(path = "brix.command.admin")
    private String adminCommandAliases = "brixadmin";
    ...
    @ConfigEntry(path = "brix.command.new-player-action")
    ...
    @ConfigEntry(path = "brix.command.default-action")
    private String defaultPlayerAction = "go";

    /*      WORLD       */
    @ConfigComment("Friendly name for this world. Used in admin commands. Must be a single word")
    @ConfigEntry(path = "world.friendly-name")
    private String friendlyName = "Brix";

    @ConfigComment("Name of the world - if it does not exist then it will be generated.")
    @ConfigComment("It acts like a prefix for nether and end (e.g. brix_world, brix_world_nether, brix_world_end)")
    @ConfigEntry(path = "world.world-name")
    private String worldName = "brix_world";
    ...
    @ConfigComment("or set this permission: brix.island.range.<number>")
    ...
    @ConfigComment("Minimum is 0, which means no sea")
    ...
    @ConfigComment("The permission brix.ban.maxlimit.X where X is a number can also be used per player")
    ...
    @ConfigEntry(path = "world.nether.areas", needsReset = true)
    ...
    @ConfigComment("Only applies to areas Nether")
    ...
    @ConfigEntry(path = "world.end.areas", needsReset = true)
    private boolean endIslands = true;

    @ConfigEntry(path = "world.end.dragon-spawn", experimental = true)
    private boolean dragonSpawn = false;

    @ConfigComment("Mob white list - these mobs will NOT be removed when logging in or doing /brix")
    ...
    @ConfigComment("Players can have the brix.coop.maxsize.<number> permission to be bigger but")
    @ConfigComment("permission size cannot be less than the default below. ")
    ...
    @ConfigComment("Players can have the brix.trust.maxsize.<number> permission to be bigger but")
    @ConfigComment("permission size cannot be less than the default below. ")
    ...
    @ConfigComment("Brix blocked mobs.")
    @ConfigComment("List of mobs that should not spawn in Brix.")
